...
class DietsControllerTest < ActionController::TestCase
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post :create, diet: { author: @diet.author, difficulty: @diet.difficulty, duration: @diet.duration, published_at: @diet.published_at, title: @diet.title }
    end
  ...
  test "should update diet" do
    patch :update, id: @diet, diet: { author: @diet.author, difficulty: @diet.difficulty, duration: @diet.duration, published_at: @diet.published_at, title: @diet.title }
    assert_redirected_to diet_path(assigns(:diet))
  end
